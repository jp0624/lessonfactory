...
CREATE TABLE `country_language` (
  ...
  `country_code` char(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_code` char(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`country_language_id`)
) ENGINE=InnoDB AUTO_INCREMENT=182 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AVG_ROW_LENGTH=124 ROW_FORMAT=DYNAMIC;
...
-- Dump completed on 2018-10-23 17:00:47
