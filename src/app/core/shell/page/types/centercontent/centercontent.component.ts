...
export class CentercontentComponent implements OnInit, AfterViewInit, AfterContentInit {
  @Input()
  activePage;
  @Input()
  activePageId;
  ...
  getActiveContent() {
    ...
    this.activeContent.chars = this.activePage.content[this.contentId].headings.heading;
    this.activeContent.chars += this.activePage.content[this.contentId].headings.text;
